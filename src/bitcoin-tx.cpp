...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vertexcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vertexcoin-tx [options] <hex-tx> [commands]  Update hex-encoded vertexcoin transaction\n" +
            "or:     vertexcoin-tx [options] -create [commands]   Create hex-encoded vertexcoin transaction\n" +
            "\n";
