...
"""Verify that starting vertexcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vertexcoin with -h for help text")
        ...
        self.log.info("Start vertexcoin with -version for version information")
        ...
        self.log.info("Start vertexcoind with -fakearg to make sure it does not start")
