# Support for Output Descriptors in Vertexcoin Core

Since Vertexcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Vertexcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Vertexcoin Core wallets, a convenience function `combo` is
