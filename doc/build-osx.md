...
1. Clone the Vertexcoin Core source code:

        git clone https://github.com/vertexcoin/vertexcoin
        cd vertexcoin

2.  Build Vertexcoin Core:

    Configure and build the headless Vertexcoin Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/vertexcoin/src
        cp vertexcoind /usr/local/bin/
        cp vertexcoin-cli /usr/local/bin/

Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Vertexcoin Core may be compiled in
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Vertexcoin"

    touch "/Users/${USER}/Library/Application Support/Vertexcoin/vertexcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Vertexcoin/vertexcoin.conf"

The first time you run vertexcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
